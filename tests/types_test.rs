...
fn test_jira_status_serialization() {
    ...
    assert_eq!(status.status_category.color_name, deserialized.status_category.color_name);
    assert_eq!(status.status_category.name, deserialized.status_category.name);
}
...
fn test_transition_properties_with_all_properties() {
    ...
    assert!(matches!(props.availability, AvailabilityProperty::Available));
    assert!(matches!(props.conditionality, ConditionalityProperty::Conditional));
}
...
fn test_initialize_result_serialization() {
    ...
    assert_eq!(result.capabilities.tools.is_some(), deserialized.capabilities.tools.is_some());
...
fn test_bulk_operation_summary_serialization() {
    ...
    assert_eq!(summary.successful_operations, deserialized.successful_operations);
